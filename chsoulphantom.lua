...
local Window = Library.CreateLib("Phantom Forces - CheaterSoul", "Sentinel")
...
sclobby1:NewButton("Website", "Website: https://cheatersoul.com", function()
    setclipboard("https://cheatersoul.com")
end)
